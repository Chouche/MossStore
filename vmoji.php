...
<body>
    ...
    <!-- top-bar -->
    <div class="top-bar vmoji">
        <h1>Vmoji</h1>
        <p>AR App / Social / Mobile</p>
    </div>
    <!-- end top-bar -->
    ...
    <div class="container main-container">
        <div class="col-md-12">
            <img src="img/Vmoji.jpg" alt="" class="img-responsive"/>
            <div class="h-30"></div>
        </div>

        <div class="col-md-12">
            <h3 class="text-uppercase">Vmoji</h3>
        ...
        <div class="col-md-9">
            ...
            <br>
            <?php if (!isset($_SESSION['user'])) : ?>
            <a href="login.php?page=vmoji" class="btn-liquid">
